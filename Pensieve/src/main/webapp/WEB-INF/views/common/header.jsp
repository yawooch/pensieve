...
<script async
    src="https://www.googletagmanager.com/gtag/js?id=G-KGDJBEFF3W"></script>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav">
                    <li class="nav-item dropdown" data-bs-theme="light"><a
                        ...
                        href="${path}/" id="main">Main</a>
                        <div class="dropdown-menu" aria-labelledby="main">
                            <a class="dropdown-item" href="${path}/main/text">text</a> <a
                                class="dropdown-item" href="${path}/main/calendar">calendar</a>
                    ...
                    <li class="nav-item dropdown" data-bs-theme="light"><a
                        ...
                        <div class="dropdown-menu" aria-labelledby="wc">
                            <a class="dropdown-item" href="${path}/wc/text">text</a> <a
                                class="dropdown-item" href="${path}/wc/calendar">calendar</a> <a
                                class="dropdown-item" href="${path}/wc/timeline">timeline</a>
                        </div></li>
                    <li class="nav-item dropdown" data-bs-theme="light"><a
                        class="nav-link dropdown-toggle" data-bs-toggle="dropdown"
                        href="#" id="yw">영우</a>
                        <div class="dropdown-menu" aria-labelledby="yw">
                            <a class="dropdown-item" href="${path}/yw/text">text</a> <a
                                class="dropdown-item" href="${path}/yw/calendar">calendar</a>
                        </div></li>
                    <li class="nav-item dropdown" data-bs-theme="light"><a
                        class="nav-link dropdown-toggle" data-bs-toggle="dropdown"
                        href="${path}/jy" id="jy">주연</a>
                        <div class="dropdown-menu" aria-labelledby="jy">
                            <a class="dropdown-item" href="${path}/jy/memo">memo</a> <a
                                class="dropdown-item" href="${path}/jy/calendar">calendar</a> <a
                                class="dropdown-item" href="${path}/jy/todo">todo list</a>
                        </div></li>
                    <li class="nav-item dropdown" data-bs-theme="light"><a
                        class="nav-link dropdown-toggle" data-bs-toggle="dropdown"
                        href="#" id="yh">연희</a>
                    ...
                    <li class="nav-item dropdown" data-bs-theme="light"><a
                        ...
                        <div class="dropdown-menu" aria-labelledby="ja">
                            <a class="dropdown-item" href="${path}/ja/text">text</a> <a
                                class="dropdown-item" href="${path}/ja/calendar">calendar</a>
                        </div></li>
                    <li class="nav-item dropdown" data-bs-theme="light"><a
                        class="nav-link dropdown-toggle" data-bs-toggle="dropdown"
                        href="${path}/" id="template">Template</a>
                        <div class="dropdown-menu" aria-labelledby="template">
                            <a class="dropdown-item" href="${path}/template/themePage"
                                id="themes">Theme</a> <a class="dropdown-item"
                                href="${path}/template/text">text</a> <a class="dropdown-item"
                                href="${path}/template/timeline">timeline</a> <a
                                class="dropdown-item" href="${path}/template/calendar1">calendar1
                            </a> <a class="dropdown-item" href="${path}/template/calendar2">calendar2
                            </a> <a class="dropdown-item" href="${path}/template/calendar3">calendar3
                            </a> <a class="dropdown-item" href="${path}/template/calendar4">calendar4
                            </a> <a class="dropdown-item" href="${path}/template/calendar5">calendar5
                            </a> <a class="dropdown-item" href="${path}/template/calendar6">calendar6
                            </a> <a class="dropdown-item" href="${path}/template/calendar7">calendar7
                            </a> <a class="dropdown-item" href="${path}/template/calendar8">calendar8
                            </a> <a class="dropdown-item" href="${path}/template/calendar9">calendar9
                            </a> <a class="dropdown-item" href="${path}/template/calendar10">calendar10</a>
                ...
                <c:if test="${ not empty loginMember }">
                    ...
                    <ul class="navbar-nav ms-md-auto">
                        ...
                        <a
                            ...
                            href="${path}/mypage" id="user-menu" aria-expanded="false"
...
<!--                                         <i class="bi wrench-adjustable-circle"></i><span class="ms-2">Admin Page</span> -->
                                ...
                                <li>
                                    <a type="button" href="${path}/logout"
                                        ...
                                        <i class="bi bi-box-arrow-right"></i><span class="ms-2">Log Out</span>
                                    </a>
                                </li>
                            </ul></li>
                        </li>
