...
!(function (e, t) {
    ...
    var e = Object.defineProperty,
        ...
        s = (t, a, n) => (a in t ? e(t, a, { enumerable: !0, configurable: !0, writable: !0, value: n }) : (t[a] = n)),
        l = (e, l) => {
    ...
    class u {
        constructor() {
            ...
            r(this, "isInit", !1),
                ...
                r(this, "months", 2),
                r(this, "jumpMonths", 1),
                r(this, "date", { min: "1970-01-01", max: "2470-12-31", today: new Date() }),
                r(this, "settings", {
                    lang: "en",
                    iso8601: !0,
                    range: { min: this.date.min, max: this.date.max, disablePast: !1, disableGaps: !1, disableAllDays: !1, disableWeekday: void 0, disabled: void 0, enabled: void 0 },
                    selection: { day: "single", month: !0, year: !0, time: !1, controlTime: "all", stepHours: 1, stepMinutes: 1, cancelableDay: !0 },
                    selected: { dates: void 0, month: void 0, year: void 0, holidays: void 0, time: void 0 },
                    visibility: { theme: "system", themeDetect: "html[data-theme]", monthShort: !0, weekNumbers: !1, weekend: !0, today: !0, disabled: !1, daysOutside: !0, positionToInput: "left" },
                }),
    ...
    const m = (e) => `${e.getFullYear()}-${String(e.getMonth() + 1).padStart(2, "0")}-${String(e.getDate()).padStart(2, "0")}`,
            ...
            e.reduce(
                (e, t) => (
                    t.match(/^(\d{4}-\d{2}-\d{2})$/g)
                        ? e.push(t)
                        : t.replace(/(\d{4}-\d{2}-\d{2}).*?(\d{4}-\d{2}-\d{2})/g, (t, a, n) => {
                              const s = g(a),
                                  l = g(n),
        ...
        y = (e) => (e ? { 0: "12", 13: "01", 14: "02", 15: "03", 16: "04", 17: "05", 18: "06", 19: "07", 20: "08", 21: "09", 22: "10", 23: "11" }[Number(e)] || String(e) : ""),
        v = (e) => `${e} is not found, check the first argument passed to new VanillaCalendar.`,
        M = 'The calendar has not been initialized, please initialize it using the "init()" method first.',
        S = 'You specified "define" for "settings.lang" but did not provide the required values for "locale.weekday" or "locale.months".',
        ...
        b = (e) => {
            (e.currentType = e.type),
                ((e) => {
                    const t = void 0 !== e.settings.selected.month && Number(e.settings.selected.month) >= 0 && Number(e.settings.selected.month) < 12,
                ...
                ((e) => {
                    var t, a, n;
                    (e.settings.range.min = g(e.date.min) >= g(e.settings.range.min) ? e.date.min : e.settings.range.min), (e.settings.range.max = g(e.date.max) <= g(e.settings.range.max) ? e.date.max : e.settings.range.max);
                    const s = e.settings.range.disablePast && !e.settings.range.disableAllDays && g(e.settings.range.min) < e.date.today;
                    (e.rangeMin = s || e.settings.range.disableAllDays ? m(e.date.today) : e.settings.range.min),
                        (e.rangeMax = e.settings.range.disableAllDays ? m(e.date.today) : e.settings.range.max),
                        (e.rangeDisabled = e.settings.range.disabled && !e.settings.range.disableAllDays ? h(e.settings.range.disabled) : e.settings.range.disableAllDays ? [e.rangeMin] : []),
                        e.rangeDisabled.length > 1 && e.rangeDisabled.sort((e, t) => +new Date(e) - +new Date(t)),
                        (e.rangeEnabled = e.settings.range.enabled ? h(e.settings.range.enabled) : []),
                        ...
                        (null == (n = e.rangeEnabled) ? void 0 : n[0]) && e.settings.range.disableAllDays && ((e.rangeMin = e.rangeEnabled[0]), (e.rangeMax = e.rangeEnabled[e.rangeEnabled.length - 1]));
                })(e),
                ((e) => {
                    var t, a;
                    (e.selectedDates = (null == (t = e.settings.selected.dates) ? void 0 : t[0]) ? h(e.settings.selected.dates) : []),
                        (e.selectedHolidays = (null == (a = e.settings.selected.holidays) ? void 0 : a[0]) ? h(e.settings.selected.holidays) : []);
                })(e),
                ((e) => {
                ...
                ((e) => {
                    ...
                    if (t || 24 === e.settings.selection.time) {
                        ...
                        if ("string" == typeof e.settings.selected.time) {
                            ...
                            e.settings.selected.time.replace(n, (n, s, l, r) => (s && l && ((a = !0), (e.selectedHours = s), (e.selectedMinutes = l)), r && t ? (e.selectedKeeping = r) : t && (e.selectedKeeping = "AM"), ""));
                        }
                        !a && t
                            ? ((e.selectedHours = y(String(e.date.today.getHours()))), (e.selectedMinutes = String(e.date.today.getMinutes())), (e.selectedKeeping = Number(e.date.today.getHours()) >= 12 ? "PM" : "AM"))
                            : a || ((e.selectedHours = String(e.date.today.getHours())), (e.selectedMinutes = String(e.date.today.getMinutes()))),
                            (e.selectedHours = Number(e.selectedHours) < 10 ? `0${Number(e.selectedHours)}` : `${e.selectedHours}`),
        ...
        w = (e) => {
            ...
            const n = null == (t = e.HTMLElement) ? void 0 : t.querySelector(`.${e.CSSClasses.arrowPrev}`),
                s = null == (a = e.HTMLElement) ? void 0 : a.querySelector(`.${e.CSSClasses.arrowNext}`);
            if (!n || !s) return;
            ({
                default: () => {
                    ...
                    a.setMonth(a.getMonth() - e.jumpMonths), l.setMonth(l.getMonth() + e.jumpMonths), e.settings.selection.year || (e.dateMin.setFullYear(t.getFullYear()), e.dateMax.setFullYear(t.getFullYear()));
                    const r = !e.settings.selection.month || a.getFullYear() < e.dateMin.getFullYear() || (a.getFullYear() === e.dateMin.getFullYear() && a.getMonth() < e.dateMin.getMonth()),
                        i = !e.settings.selection.month || l.getFullYear() > e.dateMax.getFullYear() || (l.getFullYear() === e.dateMax.getFullYear() && l.getMonth() > e.dateMax.getMonth());
                    f({ arrowPrev: n, arrowNext: s, isPrevHidden: r, isNextHidden: i });
                },
                year: () => {
                    f({ arrowPrev: n, arrowNext: s, isPrevHidden: e.dateMin.getFullYear() && e.viewYear - 7 <= e.dateMin.getFullYear(), isNextHidden: e.dateMax.getFullYear() && e.viewYear + 7 >= e.dateMax.getFullYear() });
                },
        ...
        $ = (e, t, a, n, s, l, r, i) => {
            ...
            (o.className = `${e.CSSClasses.dayBtn}${i ? ` ${i}` : ""}`), (o.type = "button"), (o.innerText = String(n)), (o.dataset.calendarDay = l);
            e.settings.visibility.weekNumbers &&
                ...
                ((e, t, a) => {
                    var n, s, l, r, i;
                    const d = null == (n = e.settings.range.disableWeekday) ? void 0 : n.includes(a),
                    ...
                    (!d && !o) ||
                        ...
                        (e.rangeDisabled.push(t), null == (i = e.rangeDisabled) || i.sort((e, t) => +new Date(e) - +new Date(t)));
                })(e, l, s),
                ((e, t, a, n, s, l, r) => {
                    var i, d, o;
                    (g(e.rangeMin) > g(l) || g(e.rangeMax) < g(l) || (null == (i = e.rangeDisabled) ? void 0 : i.includes(l)) || (!e.settings.selection.month && r) || (!e.settings.selection.year && g(l).getFullYear() !== t)) &&
                        (n.classList.add(e.CSSClasses.dayBtnDisabled), (n.tabIndex = -1)),
                        e.settings.visibility.today && m(e.date.today) === l && n.classList.add(e.CSSClasses.dayBtnToday),
                        ...
                        (null == (o = e.selectedDates) ? void 0 : o.includes(l)) &&
                            ...
                            e.selectedDates.length > 1 &&
                                ...
                                (e.selectedDates[0] === l && a.classList.add(e.CSSClasses.daySelectedFirst),
        ...
        E = (e) => {
            var t, a;
            const n = null == (t = e.HTMLElement) ? void 0 : t.querySelectorAll("[data-calendar-selected-month]"),
                s = null == (a = e.HTMLElement) ? void 0 : a.querySelectorAll("[data-calendar-selected-year]");
            ...
            null == n ||
                ...
                null == s ||
                    s.forEach((t, a) =>
                        ((e, t, a, n) => {
                            const s = new Date(n.setFullYear(e.selectedYear, e.selectedMonth + a)).getFullYear(),
        ...
        H = (e, t) => {
            ...
            ({ prev: () => a.setMonth(a.getMonth() - e.jumpMonths), next: () => a.setMonth(a.getMonth() + e.jumpMonths) }[t](), ([e.selectedMonth, e.selectedYear] = [a.getMonth(), a.getFullYear()]), E(e), w(e), L(e));
        },
        k = Object.freeze(
        ...
        Y = (e, t) =>
            t
                ...
                .replace(/[\n\t]/g, ""),
        x = (e, t) => {
            const { HTMLElement: a, CSSClasses: n, DOMTemplates: s, type: l, currentType: r, correctMonths: i } = e,
                d = (s, l) => {
                    if (!t) return;
                ...
                o = {
                    default: () => {
                        a.classList.add(n.calendarDefault), a.classList.remove(n.calendarMonth, n.calendarYear), (a.innerHTML = Y(e, s.default));
                    },
                    multiple: () => {
                        i &&
                    ...
                    month: () => {
                        "multiple" !== l ? (a.classList.add(n.calendarMonth), a.classList.remove(n.calendarDefault, n.calendarYear), (a.innerHTML = Y(e, s.month))) : d(n.columnMonth, s.month);
                    },
                    year: () => {
                        "multiple" !== l ? (a.classList.add(n.calendarYear), a.classList.remove(n.calendarDefault, n.calendarMonth), (a.innerHTML = Y(e, s.year))) : d(n.columnYear, s.year);
                    },
                };
        ...
        _ = (e, t, a, n, s) => {
            ...
            return (
                (l.className = `${e.CSSClasses.yearsYear}${a === s ? ` ${e.CSSClasses.yearsYearSelected}` : n ? ` ${e.CSSClasses.yearsYearDisabled}` : ""}`),
        ...
        A = (e) => `${e.charAt(0).toUpperCase()}${e.substring(1, e.length)}`.replace(/\./, ""),
        F = (e, t) => {
            const a = new Date(`1978-01-0${t + 1}T00:00:00.000Z`).toLocaleString(e.settings.lang, { weekday: "short", timeZone: "UTC" });
            e.locale.weekday.push(A(a));
        },
        I = (e, t) => {
            const a = new Date(`1978-${t + 1 <= 9 ? `0${t + 1}` : t + 1}-01T00:00:00.000Z`).toLocaleString(e.settings.lang, { month: "long", timeZone: "UTC" });
        ...
        q = (e, t, a, n, s, l) => {
            ...
            return (
                (r.className = `${e.CSSClasses.monthsMonth}${a === l ? ` ${e.CSSClasses.monthsMonthSelected}` : s ? ` ${e.CSSClasses.monthsMonthDisabled}` : ""}`),
                (r.title = n),
                (r.innerText = `${e.settings.visibility.monthShort ? n.substring(0, 3) : n}`),
        ...
        B = (e, t) => {
            ...
            const s = (null == t ? void 0 : t.dataset.calendarSelectedMonth) ? Number(t.dataset.calendarSelectedMonth) : e.selectedMonth,
                l = null == (a = null == t ? void 0 : t.closest(`.${e.CSSClasses.column}`)) ? void 0 : a.querySelector(`.${e.CSSClasses.year}`),
            ...
            for (let t = 0; t < 12; t++) {
                const a = e.locale.months[t],
                    n = (t < e.dateMin.getMonth() + P(e) && r <= e.dateMin.getFullYear()) || (t > e.dateMax.getMonth() + P(e) && r >= e.dateMax.getFullYear()) || (t !== s && !d.includes(t)),
                    l = q(e, o, s, a, n, t);
        ...
        j = (e, t, a, n) => {
            ({
                ...
                e.input && e.HTMLInputElement && e.actions.changeToInput && e.actions.changeToInput(t, e));
        },
        R = (e, t, a, n, s, l) => {
            t.addEventListener("input", (t) => {
                ...
                i < l && i > 0
                    ? ((a.value = d), (e.selectedKeeping = "AM"), (n.innerText = e.selectedKeeping), j(e, t, d, s))
                    : (0 === i ? ((e.selectedKeeping = "AM"), (n.innerText = "AM")) : ((e.selectedKeeping = "PM"), (n.innerText = "PM")), (a.value = y(r.value)), j(e, t, y(r.value), s));
            });
        },
        z = (e, t, a, n, s, l) => {
            a.addEventListener("change", (a) => {
                ...
                "hours" === s && 12 === l
                    ? r.value && i <= l && i > 0
                        ? ((r.value = d), (t.value = W(d, e.selectedKeeping)), j(e, a, d, s))
                        : r.value && i < 24 && (i > l || 0 === i)
                        ? (0 === i ? ((e.selectedKeeping = "AM"), (n.innerText = "AM")) : ((e.selectedKeeping = "PM"), (n.innerText = "PM")), (r.value = y(r.value)), (t.value = d), j(e, a, y(r.value), s))
                ...
                d &&
                    ((e, t, a) => {
                        t.addEventListener("click", (n) => {
                            (e.selectedKeeping = t.innerText.includes("AM") ? "PM" : "AM"), (t.innerText = e.selectedKeeping), (a.value = W(e.selectedHours, e.selectedKeeping)), j(e, n, e.selectedHours, "hours");
                        });
                    })(e, d, s);
        },
        Z = (e, t, a, n) => `<label class="${t}"><input type="text"name="${e}"maxlength="2"value="${a}"${n ? "disabled" : ""}></label>`,
        U = (e, t, a, n, s, l) => `<label class="${t}"><input type="range"name="${e}"min="${a}"max="${n}"step="${s}"value="${l}"></label>`,
        V = (e) => {
                            ...
                            (r.className = `${e.CSSClasses.weekDay}${
                                e.settings.visibility.weekend && e.settings.iso8601
                                    ? 5 === s || 6 === s
                                        ...
                                        : ""
                                    : !e.settings.visibility.weekend || e.settings.iso8601 || (0 !== s && 6 !== s)
                                    ? ""
                                    : ` ${e.CSSClasses.weekDayWeekend}`
                            }`),
                            (r.innerText = `${l}`),
        ...
        te = (e, t) => {
            var a;
            if (((a = t), ee(e.HTMLElement, a.matches ? "dark" : "light"), "system" !== e.settings.visibility.theme || J.check())) return;
            const n = (t) => {
                const a = document.querySelectorAll(`.${e.CSSClasses.calendar}`);
                null == a || a.forEach((e) => ee(e, t.matches ? "dark" : "light"));
            };
            t.addEventListener ? t.addEventListener("change", n) : t.addListener(n), J.set();
        },
        ae = (e, t) => {
            ...
            const n = e.settings.visibility.themeDetect.replace(/^.*\[(.+)\]/g, (e, t) => t),
                s = Q(a, n);
            s
                ? (ee(e.HTMLElement, s),
                  ((e, t, a) => {
        ...
        ne = (e) => {
            ...
            ((e) => {
                ...
                if ("not all" === window.matchMedia("(prefers-color-scheme)").media) return void ee(e.HTMLElement, "light");
                ({ light: () => ee(e.HTMLElement, "light"), dark: () => ee(e.HTMLElement, "dark"), system: () => ae(e, window.matchMedia("(prefers-color-scheme: dark)")) }[e.settings.visibility.theme]());
            })(e),
                ((e) => {
                ...
                ((e) => {
                    ...
                    if (!t) return;
                    const a = !0 === e.settings.selection.time ? 12 : e.settings.selection.time,
                        n = "range" === e.settings.selection.controlTime,
                        [s, l] = [0, 23],
                        [r, i] = [0, 59];
                    (t.innerHTML = `<div class="${e.CSSClasses.timeContent}">${Z("hours", e.CSSClasses.timeHours, e.selectedHours, n)}${Z("minutes", e.CSSClasses.timeMinutes, e.selectedMinutes, n)}${
                        12 === a ? `<button type="button" class="${e.CSSClasses.timeKeeping}"${n ? "disabled" : ""}>${e.selectedKeeping}</button>` : ""
                    }</div><div class="${e.CSSClasses.timeRanges}">${U("hours", e.CSSClasses.timeRange, s, l, e.settings.selection.stepHours, e.selectedKeeping ? W(e.selectedHours, e.selectedKeeping) : e.selectedHours)}${U(
                        "minutes",
        ...
        le = () => {
            ...
            se.self.HTMLElement.querySelectorAll(`.${se.self.CSSClasses.dayBtnHover}`).forEach((e) => {
                var a;
                e.classList.remove(se.self.CSSClasses.dayBtnHover), null == (a = e.parentElement) || a.classList.remove(t.dayHoverIntermediate, t.dayHoverFirst, t.dayHoverLast);
            });
        },
        re = (e, t, a) => {
            var n, s, l;
            ...
            const d = null == (l = se.self.HTMLElement) ? void 0 : l.querySelectorAll(`[data-calendar-day="${r}"]`);
            null == d ||
                d.forEach((e) => {
                    var t;
        ...
        ie = (e) => {
            var t;
            if (!e.target || !(null == (t = se.self) ? void 0 : t.selectedDates)) return;
            ...
            const n = a.dataset.calendarDay,
                ...
                l = g(n),
                r = se.self.HTMLElement.querySelectorAll(`[data-calendar-day="${se.self.selectedDates[0]}"]`),
        ...
        de = (e) => {
            se.self && "Escape" === e.key && ((se.self.selectedDates = []), se.self.HTMLElement.removeEventListener("mousemove", ie), document.removeEventListener("keydown", de), ne(se.self));
        },
        oe = (e, t) => {
            var a;
            if (t) {
            ...
            e.settings.range.disableGaps && ((se.rangeMin = se.rangeMin ? se.rangeMin : e.rangeMin), (se.rangeMax = se.rangeMax ? se.rangeMax : e.rangeMax)), (se.self = e);
            const n = {
                set: () => {
                    e.HTMLElement.addEventListener("mousemove", ie),
                        ...
                        e.settings.range.disableGaps &&
                            (() => {
                                var e, t, a;
                                if (!(null == (t = null == (e = se.self) ? void 0 : e.selectedDates) ? void 0 : t[0]) || !se.self.rangeDisabled || (null == (a = se.self.rangeDisabled) ? void 0 : a.length) < 2) return;
                                const n = g(se.self.selectedDates[0]),
                                    [s, l] = se.self.rangeDisabled.map((e) => g(e)).reduce(([e, t], a) => [n >= a ? a : e, n < a && null === t ? a : t], [null, null]);
                                s && (se.self.rangeMin = m(new Date(s.setDate(s.getDate() + 1)))), l && (se.self.rangeMax = m(new Date(l.setDate(l.getDate() - 1))));
                            })();
                },
                reset: () => {
                    const [t, a] = [e.selectedDates[0], e.selectedDates[e.selectedDates.length - 1]];
                    (e.selectedDates = e.selectedDates[0] !== e.selectedDates[e.selectedDates.length - 1] ? h([`${t}:${a}`]) : [e.selectedDates[0], e.selectedDates[0]]),
                        e.HTMLElement.removeEventListener("mousemove", ie),
                        document.removeEventListener("keydown", de),
                        e.settings.range.disableGaps && se.self && ((se.self.rangeMin = se.rangeMin), (se.self.rangeMax = se.rangeMax));
                },
            };
                ...
                i
                    ? ((e, t, a, n, s) => {
                          ...
                          ({
                              year: () => {
                                  if ("multiple" === e.type) {
                                      const t = ue(e, e.CSSClasses.columnYear, e.CSSClasses.year, Number(s.dataset.calendarYear), "data-calendar-selected-year"),
                                          a = e.selectedMonth < e.dateMin.getMonth() && t <= e.dateMin.getFullYear(),
                                          n = e.selectedMonth > e.dateMax.getMonth() && t >= e.dateMax.getFullYear(),
                                          l = t < e.dateMin.getFullYear(),
                                          r = t > e.dateMax.getFullYear();
                                      a || l
                                          ? ((e.selectedYear = e.dateMin.getFullYear()), (e.selectedMonth = e.dateMin.getMonth()))
                                          : n || r
                                          ? ((e.selectedYear = e.dateMax.getFullYear()), (e.selectedMonth = e.dateMax.getMonth()))
                                          : (e.selectedYear = t);
                                  } else e.selectedYear = Number(s.dataset.calendarYear);
                              },
                              month: () => {
                                  if ("multiple" === e.type) {
                                      const t = ue(e, e.CSSClasses.columnMonth, e.CSSClasses.month, Number(s.dataset.calendarMonth), "data-calendar-selected-month"),
                                          a = s.closest(`.${n.column}`).querySelector(`.${e.CSSClasses.year}`);
                                      e.selectedYear = Number(a.dataset.calendarSelectedYear);
                                      const l = t < e.dateMin.getMonth() && e.selectedYear <= e.dateMin.getFullYear(),
                                          r = t > e.dateMax.getMonth() && e.selectedYear >= e.dateMax.getFullYear();
                    ...
                    : ((e.currentType === a && r) || ("multiple" === e.type && e.currentType === a && d && !o)) && ((e.currentType = e.type), ne(e));
        },
        ge = (e) => {
            const t = (t) => {
                ((e, t) => {
                    ...
                    a &&
                        (["default", "multiple"].includes(e.currentType)
                            ...
                            : "year" === e.currentType && void 0 !== e.viewYear && ((e.viewYear += { prev: -15, next: 15 }[a.dataset.calendarArrow]), N(e, t.target)),
                    ...
                    ((e, t) => {
                        ...
                        const n = t.target.closest(`.${e.CSSClasses.weekNumber}`),
                            s = null == (a = e.HTMLElement) ? void 0 : a.querySelectorAll("[data-calendar-week-number]");
                        if (!n || !s) return;
                        const l = Number(n.innerText),
                            r = Number(n.dataset.calendarYearWeek),
                            i = [...s].filter((e) => Number(e.dataset.calendarWeekNumber) === l);
                    ...
                    ((e, t) => {
                        ...
                        ({ single: () => ce(e, l, !1), multiple: () => ce(e, l, !0), "multiple-ranged": () => oe(e, l.dataset.calendarDay) }[e.settings.selection.day](),
                            null == (a = e.selectedDates) || a.sort((e, t) => +new Date(e) - +new Date(t)),
                        ...
                        ({ prev: () => H(e, "prev"), next: () => H(e, "next"), default: () => L(e) }[r ? "prev" : i ? "next" : "default"]());
                    })(e, t),
                    me(e, t, "month", { header: e.CSSClasses.month, item: e.CSSClasses.monthsMonth, column: e.CSSClasses.columnMonth }),
                    me(e, t, "year", { header: e.CSSClasses.year, item: e.CSSClasses.yearsYear, column: e.CSSClasses.columnYear });
            };
        ...
        he = (e, { year: t, month: a, dates: n, holidays: s, time: r } = {}) => {
            ...
            (e.settings.selected.year = t ? d.year : e.selectedYear),
                ...
                (e.settings.selected.dates = "only-first" === n && (null == (i = e.selectedDates) ? void 0 : i[0]) ? [e.selectedDates[0]] : !0 === n ? d.dates : e.selectedDates),
                b(e),
                ne(e),
        ...
        ye = (e, t, a, n) => {
            const s = { top: -t.offsetHeight, bottom: e.offsetHeight, left: 0, center: e.offsetWidth / 2 - t.offsetWidth / 2, right: e.offsetWidth - t.offsetWidth },
        ...
        ve = (e) => {
            ...
            const n = () => ye(e.HTMLInputElement, e.HTMLElement, e.settings.visibility.positionToInput, e.CSSClasses),
                s = (t) => {
                    var a;
                    e &&
                        t.target !== e.HTMLInputElement &&
                        !(null == (a = e.HTMLElement) ? void 0 : a.contains(t.target)) &&
                        (e.HTMLInputElement && e.HTMLElement && e.hide(), window.removeEventListener("resize", n), document.removeEventListener("click", s, { capture: !0 }));
                };
            return (
                        ...
                        ? a.push(
                              (() => {
                                  ...
                                  return (
                                      ...
                                      (t = !1),
                                      setTimeout(() => {
                                          ye(e.HTMLInputElement, a, e.settings.visibility.positionToInput, e.CSSClasses), e.show();
                                      }, 0),
                                      he(e, { year: !0, month: !0, dates: !0, holidays: !0, time: !0 }),
                                      e.actions.initCalendar && e.actions.initCalendar(e),
                                      ge(e)
                                  );
                              })()
                          )
                        : (ye(e.HTMLInputElement, e.HTMLElement, e.settings.visibility.positionToInput, e.CSSClasses), e.show()),
    ...
    return class extends u {
        constructor(e, t) {
            if (
                (super(),
                r(this, "init", () => {
                    return ((e = this).HTMLOriginalElement = e.HTMLElement.cloneNode(!0)), (e.isInit = !0), e.input ? ve(e) : (b(e), ne(e), e.actions.initCalendar && e.actions.initCalendar(e), ge(e));
                    var e;
                }),
                r(this, "update", (e) =>
                    ((e, { year: t, month: a, dates: n, holidays: s, time: l } = {}) => {
                        if (!e.isInit) throw new Error(M);
                        he(e, { year: t, month: a, dates: n, holidays: s, time: l }), e.actions.updateCalendar && e.actions.updateCalendar(e);
                    })(this, e)
                ),
                r(this, "destroy", () =>
                    ((e) => {
                        ...
                        if (!e.isInit) throw new Error(M);
                        e.input
                            ? (null == (a = null == (t = e.HTMLElement) ? void 0 : t.parentElement) || a.removeChild(e.HTMLElement), null == (n = e.HTMLInputElement) || n.replaceWith(e.HTMLOriginalElement), (e.HTMLInputElement = void 0))
                            : null == (s = e.HTMLElement) || s.replaceWith(e.HTMLOriginalElement),
