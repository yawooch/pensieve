...
CREATE TABLE "MEMBER" (
    ...
    "ROLE"        VARCHAR2(20)    DEFAULT 'ROLE_USER' NULL
);
...
COMMENT ON COLUMN "MEMBER"."ROLE"        IS '사용자권한';
...
CREATE TABLE "MENU" (
    ...
    "MENU_PARENT_ID"   VARCHAR2(20)    NULL,
    "MENU_CREATE_DATE" DATE            DEFAULT SYSDATE NOT NULL
);
...
COMMENT ON COLUMN "MENU"."MENU_CREATE_DATE" IS '메뉴생성일자';
...
CREATE TABLE "MEMORY" (
    ...
    "MEMBER_ID"     VARCHAR2(50)    NOT NULL,
    "SHOW_DIV"      VARCHAR2(3)     DEFAULT 'Y' NOT NULL
);
...
COMMENT ON COLUMN "MEMORY"."MEMBER_ID"   IS '사용자아이디';
COMMENT ON COLUMN "MEMORY"."SHOW_DIV"    IS '보여주기구분';
...
CREATE TABLE "CATEGORY_COLOR" (
    ...
    "CTGR_COLOR"   VARCHAR2(30)        NOT NULL,
    "MEMBER_ID"    VARCHAR2(50)        NOT NULL,
    "CREATE_DATE"  DATE                DEFAULT SYSDATE NOT NULL
);

COMMENT ON TABLE  "CATEGORY_COLOR"               IS '카테고리색상';
COMMENT ON COLUMN "CATEGORY_COLOR"."CATEGORY"    IS '카테고리명';
COMMENT ON COLUMN "CATEGORY_COLOR"."CTGR_COLOR"  IS '카테고리색상';
COMMENT ON COLUMN "CATEGORY_COLOR"."MEMBER_ID"   IS '사용자아이디';
COMMENT ON COLUMN "CATEGORY_COLOR"."CREATE_DATE" IS '생성일자';




CREATE TABLE "MEMORY_HASHTAG" (
    "MEMORY_ID"    NUMBER(3)           NOT NULL,
...
COMMENT ON TABLE  "MEMORY_HASHTAG"               IS '메모리별해시태그';
COMMENT ON COLUMN "MEMORY_HASHTAG"."MEMORY_ID"   IS '메모리아이디';
COMMENT ON COLUMN "MEMORY_HASHTAG"."HASHTAG"     IS '해시태그';
COMMENT ON COLUMN "MEMORY_HASHTAG"."MEMBER_ID"   IS '사용자아이디';
COMMENT ON COLUMN "MEMORY_HASHTAG"."CREATE_DATE" IS '생성일자';
...
ALTER TABLE "CATEGORY_COLOR"  ADD CONSTRAINT "PK_CATEGORY_COLOR"  PRIMARY KEY ("CATEGORY");
